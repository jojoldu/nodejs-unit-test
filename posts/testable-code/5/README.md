...
SQL Builder를 통해서 Native Query를 작성하는 것이 안좋은 방법이라는 것은 아니며, 통계/정산/물류 등 복잡한 조회 Query가 필요하거나, 쿼리 성능 개선이 필요한 경우 등등에서 가장 좋은 방법 중 하나이다.  
...
* 발행일이 현재보다 과거인 블로그 글을 모두 가져오는 함수
